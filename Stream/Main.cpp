...
const int HEIGHT = IMAGE_HEIGHT + 310;
const int FPS = 60;
const int COLOR_FILTER = 4;
...
int main()
{
	...
	while(run)
	{
		...
		if(flip)
			drawText(20, thr_rect.y+150, font, "Edge Detection");
		else
			drawText(20, thr_rect.y+150, font, "Movement Detection");
		if(flipc == 0)
			drawText(20, thr_rect.y+200, font, "No Color");
		else if(flipc == 1)
			drawText(20, thr_rect.y+200, font, "Color");
		else if(flipc == 2)
			drawText(20, thr_rect.y+200, font, "Cartoon");
		else if(flipc == 3)
			drawText(20, thr_rect.y+200, font, "Reversed Cartoon");
